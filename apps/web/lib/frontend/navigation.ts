...
export const navigationItems: readonly NavigationItem[] = [
  ...
  { label: copy.myChildren, href: '/children', icon: GraduationCap, permission: 'students.read', roles: ['PARENT'] },
  { label: copy.teachers, href: '/teachers', icon: UserRoundCheck, permission: 'teachers.read', roles: STAFF_ROLES },
  { label: copy.parents, href: '/parents', icon: Users, permission: 'parents.read', roles: ADMIN_ROLES },
  { label: copy.grades, href: '/grades', icon: ClipboardList, permission: 'grades.read', roles: STAFF_ROLES },
  { label: copy.attendance, href: '/attendance', icon: CalendarCheck, permission: 'attendance.read', roles: STAFF_ROLES },
